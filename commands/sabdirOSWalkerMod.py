...
import re
import sys
import models.sabdirclass as sdmodclass
sys.path.insert(0, '/home/friend/bin')
...
class SabDirCourseOSWalkGrabber:
  ...
  def __init__(self, rootdir_abspath, nlist=None):
    if rootdir_abspath is None or not os.path.isdir(rootdir_abspath):
      errmsg = (
        f"Error: directory [entered={rootdir_abspath}] does not exist."
