#!/usr/bin/env python3
"""
commands/create_zinfofiles_thru_dirtree_ifitdoesnotexit.py
...
# dynamically import after inserting module's path above
...
def adhoc_test2():
  ...
  pdate = lpd.get_nearest_monday_from(today)
  scrmsg = f"Result: lpd.get_nearest_monday_from({today})={pdate}"
  print(scrmsg)
